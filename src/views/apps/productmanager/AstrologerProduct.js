...
class AstrologerProduct extends React.Component {
  state = {
    rowData: [],
              ...
              {/* <Route
                render={({ history }) => (
                  <Edit
                    ...
                    onClick={() =>
                      history.push(
                        `/app/productmanager/editproduct/${params.data._id}`
                      )
                    }
                  />
                )}
  ...
  render() {
    ...
    return (
      ...
      (
        <div>
          <Breadcrumbs
            breadCrumbTitle="Astrologer Product"
            breadCrumbParent="Product Management"
            breadCrumbActive="Astrologer Product"
          />
...
export default AstrologerProduct;
